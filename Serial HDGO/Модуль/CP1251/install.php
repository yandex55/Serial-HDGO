...
$langData = array(
  'installed' => array(
	...
	'help' => 'Поддержка модуля',
  ),
  'title' => 'Serial HDGO',
);

if ( !$isUTF ) {
	$langData['installed']['title'] = iconv("WINDOWS-1251", "UTF-8", $langData['installed']['title']);
	$langData['installed']['descr'] = iconv("WINDOWS-1251", "UTF-8", $langData['installed']['descr']);
	$langData['installed']['help'] = iconv("WINDOWS-1251", "UTF-8", $langData['installed']['help']);
}
  ...
  $dataBase[] = "ALTER TABLE `{PREFIX}_post` ADD `first_title_hdgo` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;";
...
<body>
  <div class="wrapper">
    ...
    <div class="explay"><a href="https://gameer.name/" target="_blank">'.$langData[$status]['help'].'</a></div>' ) . '
  </div>
</body>
</html>';
?>